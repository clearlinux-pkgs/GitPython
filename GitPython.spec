...
Source0  : https://files.pythonhosted.org/packages/ec/4d/e6553122c85ec7c4c3e702142cc0f5ed02e5cf1b4d7ecea86a07e45725a0/GitPython-3.1.12.tar.gz
...
%prep
%setup -q -n GitPython-3.1.12
cd %{_builddir}/GitPython-3.1.12
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1609946693
...
cp %{_builddir}/GitPython-3.1.12/LICENSE %{buildroot}/usr/share/package-licenses/GitPython/98a91252d682790e518df3df5c68339d17ab7e47
