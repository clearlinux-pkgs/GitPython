...
Source0  : https://files.pythonhosted.org/packages/59/d1/e89344ca079f92546558bb5cedb26b4f7ad4afe5319586f49b722c4d99b0/GitPython-3.1.17.tar.gz
...
%prep
%setup -q -n GitPython-3.1.17
cd %{_builddir}/GitPython-3.1.17
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1621264490
...
cp %{_builddir}/GitPython-3.1.17/LICENSE %{buildroot}/usr/share/package-licenses/GitPython/98a91252d682790e518df3df5c68339d17ab7e47
