...
Source0  : https://files.pythonhosted.org/packages/d4/a9/60a66a0e8b452726cfc5939242ffa7158c1a9a78ff628bd4540b49156240/GitPython-3.1.13.tar.gz
...
%prep
%setup -q -n GitPython-3.1.13
cd %{_builddir}/GitPython-3.1.13
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1612903054
...
cp %{_builddir}/GitPython-3.1.13/LICENSE %{buildroot}/usr/share/package-licenses/GitPython/98a91252d682790e518df3df5c68339d17ab7e47
