...
Source0  : https://files.pythonhosted.org/packages/72/ad/5cf16fd1307e0ec17fc2347475e732f64d396649c64ed358a29186f4ce74/GitPython-3.1.9.tar.gz
...
%prep
%setup -q -n GitPython-3.1.9
cd %{_builddir}/GitPython-3.1.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1601566487
...
cp %{_builddir}/GitPython-3.1.9/LICENSE %{buildroot}/usr/share/package-licenses/GitPython/98a91252d682790e518df3df5c68339d17ab7e47
