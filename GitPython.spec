...
Source0  : https://files.pythonhosted.org/packages/85/3d/ee9aa9c77a3c0e9074461d2d8da86c3564ed96abd28fa099dc3e05338a72/GitPython-3.1.11.tar.gz
...
%prep
%setup -q -n GitPython-3.1.11
cd %{_builddir}/GitPython-3.1.11
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1603462910
...
cp %{_builddir}/GitPython-3.1.11/LICENSE %{buildroot}/usr/share/package-licenses/GitPython/98a91252d682790e518df3df5c68339d17ab7e47
