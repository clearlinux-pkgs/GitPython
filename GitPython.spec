...
Source0  : https://files.pythonhosted.org/packages/41/5d/acc4f00a53d6b5383bc04517bc8f7eed16df4a9c55db49abfcacbcd931de/GitPython-3.1.5.tar.gz
Source1  : https://files.pythonhosted.org/packages/41/5d/acc4f00a53d6b5383bc04517bc8f7eed16df4a9c55db49abfcacbcd931de/GitPython-3.1.5.tar.gz.asc
...
%prep
%setup -q -n GitPython-3.1.5
cd %{_builddir}/GitPython-3.1.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1594610499
...
cp %{_builddir}/GitPython-3.1.5/LICENSE %{buildroot}/usr/share/package-licenses/GitPython/98a91252d682790e518df3df5c68339d17ab7e47
