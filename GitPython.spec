...
Source1  : https://files.pythonhosted.org/packages/5f/f2/ea3242d97695451ab1521775a85253e002942d2c8f4519ae1172c0f5f979/GitPython-3.1.14.tar.gz.asc
...
%prep
%setup -q -n GitPython-3.1.14
cd %{_builddir}/GitPython-3.1.14
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1620164425
...
cp %{_builddir}/GitPython-3.1.14/LICENSE %{buildroot}/usr/share/package-licenses/GitPython/98a91252d682790e518df3df5c68339d17ab7e47
